/**
 * Sample Skeleton for 'RichiestaAccettata.fxml' Controller Class
 */
...
public class RichiestaAccettataController {
    ...
    void initialize() {
        assert Indietro != null : "fx:id=\"Indietro\" was not injected: check your FXML file 'RichiestaAccettata.fxml'.";
        assert label != null : "fx:id=\"label\" was not injected: check your FXML file 'RichiestaAccettata.fxml'.";
